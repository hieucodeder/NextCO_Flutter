...
class _HomePageState extends State<HomePage> with TickerProviderStateMixin {
  int? totalItems, totalDocuments, totalProduct, totalMaterial, totalUser;
  ...
  void _resetState() {
    totalItems = totalDocuments = totalProduct = totalMaterial = totalUser = -1;
  ...
  Future<void> _fetchAllData() async {
    ...
    try {
      await Future.wait([
        _fetchData(
            customerService.fetchTotalItems, (result) => totalItems = result),
        ...
        _fetchData(
            userService.fetchTotalItemsUsers, (result) => totalUser = result),
      ]);
    } catch (e) {
